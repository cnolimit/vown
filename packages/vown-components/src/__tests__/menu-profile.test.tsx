...
describe('Testing Menu Profile Component', () => {
  const MenuProfileTestComponent = () => {
    return (
      <ThemeProvider theme={createMuiTheme({})}>
        <MenuProfile name={testName} role={testRole} image={testImage} email={testEmail} onSignOut={testSignOut} />
      </ThemeProvider>
    )
  }
  ...
  describe("Testing open dropdown menu", () => {
    const MenuProfileTestComponent = () => {
      return (
        <ThemeProvider theme={createMuiTheme({})}>
          <DropdownMenu name={testName} email={testEmail} onSignOut={testSignOut} />
        </ThemeProvider>
      )
    }
    const getComponent = () => render(<MenuProfileTestComponent />)
    ...
    it('Should render the account button', () => {
      ...
      expect(dropdownMyAccount).toBeDefined()
    })
